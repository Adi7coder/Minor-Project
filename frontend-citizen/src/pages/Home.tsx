...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center px-4 py-8 sm:py-16 min-h-[calc(100vh-8rem)] relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-0 w-64 h-64 bg-indigo-500/10 rounded-full blur-3xl -z-10 mix-blend-multiply"></div>
      <div className="absolute bottom-1/4 right-0 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl -z-10 mix-blend-multiply"></div>
      ...
      <div className="text-center mb-10 max-w-lg z-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
        ...
        <h1 className="text-5xl sm:text-6xl font-black text-slate-800 mb-6 leading-[1.15] tracking-tight">
          Keep <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 bg-300% animate-gradient">Bangalore</span> Beautiful.
        </h1>
      ...
      <div className="grid grid-cols-1 gap-4 w-full max-w-sm mb-12 z-10">
        <div className="glass-card p-5 rounded-3xl flex items-center gap-5 group">
          <div className="bg-indigo-50 p-3.5 rounded-2xl text-indigo-600 group-hover:scale-110 group-hover:bg-indigo-100 transition-all duration-300">
        ...
        <div className="glass-card p-5 rounded-3xl flex items-center gap-5 group">
          <div className="bg-purple-50 p-3.5 rounded-2xl text-purple-600 group-hover:scale-110 group-hover:bg-purple-100 transition-all duration-300">
      ...
      <div className="mt-12 flex gap-10 text-center z-10 bg-white/40 backdrop-blur-sm px-8 py-5 rounded-3xl border border-white/60 shadow-sm">
        ...
        <div>
          <div className="text-3xl font-black text-indigo-600 mb-1">8.5K</div>
